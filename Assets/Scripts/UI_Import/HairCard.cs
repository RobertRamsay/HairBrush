...
public class HairCard : MonoBehaviour
{
    ...
    // actually differs from what this card already carries, so an unchanged steady state can
    // skip the full mesh regeneration instead of rebuilding every card every frame.
