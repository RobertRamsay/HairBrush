...
public class ManualLinkFooterAuthority : MonoBehaviour
{
    ...
    //
    // /preview rather than the /edit link the document is shared with. /edit opens the Docs
    // editor chrome and, if the document is ever shared as "anyone with the link can edit",
    // hands a write handle to every copy of the build. /preview is a clean read-only render
    // and cannot become that.
    private const string ManualUrl =
        "https://docs.google.com/document/d/1TWEUxBKgKe0Vtg-JHQ8fPNflI3WLY5HUa-VeAgkTCuk/preview";
