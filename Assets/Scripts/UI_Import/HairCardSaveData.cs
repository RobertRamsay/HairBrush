...
[Serializable] public class HairCardSaveData { public float posX,posY,posZ; public float rotX,rotY,rotZ,rotW; public float length; public float width; public int segments; public float bendAngle; public float twistAngle; public float flattenFactor; public float embedDepth; public float offsetX,offsetY,offsetZ; public float uScale; public float vScale; public float uOffset; public float vOffset; public int groupId; }
...
public class HairProjectSaveData : ISerializationCallbackReceiver
{
    ...
    public List<GroupSaveData> groups=new(); public List<HairCardSaveData> hairCards=new();
    public float sliderLength; public float sliderWidth; public int sliderSegments; public float sliderBend; public float sliderTwist; public float sliderEmbedDepth; public float sliderOffsetX; public float sliderOffsetY; public float sliderOffsetZ; public float sliderUScale; public float sliderVScale; public float sliderUOffset; public float sliderVOffset;
    ...
    {
        // ModelViewer still has to recreate the model/cards first. The bridge restores
        // modifier state on the next safe runtime update after those cards exist.
